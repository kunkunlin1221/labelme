...
<i>Various primitives (keypoint, rectangle, circle, line, and point).</i>


## Features

- [x] Image annotation for keypoint, rectangle, circle, line and point. ([tutorial](examples/tutorial))
...
- Labels are assigned to a single keypoint. [Example](examples/bbox_detection)
